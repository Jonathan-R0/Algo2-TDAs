...
/* Crea un heap. Recibe como parámetro la función de comparación a
 * utilizar y un booleano que en caso de ser true, creará un heap de
 * máximos, de lo contrario será de mínimos. Devuelve un puntero al heap,
 * el cual debe ser destruido con heap_destruir().
 */
...
/* Devuelve el elemento con máxima prioridad o mínima prioridad, dependiendo
 * del tipo de heap que se use. Si el heap esta vacío, devuelve
 * NULL.
 * Pre: el heap fue creado.
 */
 ...
 * Si el heap esta vacío u ocurre un error, devuelve NULL.
 * Pre: el heap fue creado.
 * Post: el elemento desencolado ya no se encuentra en el heap.
 */
void *heap_desencolar(heap_t *heap);

/* Redimensiona el vector donde viven los datos del heap.
 * Puede expandirlo si ajuste es true, reducirlo en caso contrario.
 * Pre: el heap fue creado.
 * Post: devuelve true al terminar la ejecución, false en caso contrario.
 */
